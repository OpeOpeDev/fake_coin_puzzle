...
The Python code allows you to input the number of coins **n**, the number of fake coin **fake_no** and the weight of the fake coin **fake_weight**.  
It generates a random list of coin weights, with one coin being either heavier or lighter, and guides you step-by-step through the process of identifying the counterfeit coin.
